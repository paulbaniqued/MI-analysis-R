...
ggplot() +
  ...
  geom_ribbon(data = cum_ave2, aes(t_epoch_t, ymin=CI_2_lower, ymax=CI_2_upper), fill="blue", alpha=0.4) +
  geom_ribbon(data = cum_ave1, aes(t_epoch_t, ymin=CI_1_lower, ymax=CI_1_upper), fill="goldenrod3", alpha=0.4) +
